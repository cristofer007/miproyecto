	...
	<body>
		<div class="container">
			...
			<div class="row justify-content-end">
				<div class="col-auto">
					<a class="btn btn-primary" href="/vistaindex.blade.php">Salir</a>
				</div>
			</div>
			<ul class="nav mb-4">
				<li class="nav-item">
					<a class="nav-link active" href="/vistaadmin.blade.php">Tickets</a>
				</li>
				<li class="nav-item">
			...
			<div class="container bg-light mb-4 p-2">
				<div class="row mb-4">
					<div class="col-2 " >
						<a href="/vistaadmin.blade.php" >Nuevos</a>
					</div>
					<div class="col-2">
