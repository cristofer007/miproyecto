...
<html lang="en" style="max-height:100%; min-height:100%">
    ...
    <body>
        <header class="container text-white" style="position:fixed; top: 0% ;background-image:linear-gradient(50deg, #f7971e, #ffd200);">
            <div class="row h-100">
                <h2 style="" class="text-center p-1">Sistema de ayuda</h2>
                <div style="position:absolute; right:0%;" class="col-3 p-0 align-middle text-end mb-0 me-2 mt-3">
                     <a class="w-100 align-self-center" href="/vistaindex">
...
*******************************************************************************************************************************-->
            ...
            <body>
                <div class="container bg-light mb-4 p-2" style="position:absolute; top:6%">
                    <div class="row mb-4">
			<div class="container bg-light mb-4 p-2">
				...
				<div class="input-group  h-100 p-0 g-0 border border-danger">
                                    <div class="row w-100 g-0 m-auto  p-0 border border-danger">
                                        <div class="col col-sm-10 p-0 ms-0 h-100 border border-primary">
                                    ...
                                    <div class="row h-100 mh-100 my-auto p-0 border w-100 border-danger" style="min-height:100%">
                                        <div class="row d-flex flex-row m-0 p-0 h-100 g-0 w-100 justify-content-center border border-danger">
                                        <?php 
                ...
                <div id="botonNuevoTicket" class="border border-danger row-2 justify-content-center" style="position:fixed; height: 11%; width: 18%; border-radius:50%; right:2.5%; bottom:11%; background-image: radial-gradient(#005c97, #363795);">
                    <a href="/vistanuevoticket" class="text-center h-100 w-100">
                        
                        <img src="iconos/nuevoTicketIcono.png" style="height: 80%">
                    </a>
                </div>    
...
*******************************************************************************************************************************-->
		...
		<div class="modal fade" style="top:5%" id="searchModal" tabindex="-1" aria-labelledby="searchModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
...
<?php /**PATH E:\wamp64\proyecto-final\resources\views/vistaadmin.blade.php ENDPATH**/ ?>