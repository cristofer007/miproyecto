...
<!--                                        <div class="col-1">
				...
				<?php
                                        ...
                                        {
                                            $consulta =
                                                    "SELECT *, usuarios.nombre AS cliente, especialistas.nombre AS tecnico, especialistas.email AS correo_tecnico from tickets
                                                    inner join usuarios on id_solicitante = usuarios.Id 
                                                    LEFT JOIN especialistas ON especialistas.id_especialista = tickets.id_especialista WHERE id_estado = ?"  
...
//                                    ?>
							...
							<thead class="bg-light" style="position:sticky">
								<tr>
									...
									<th class="border border-dark text-center" scope="col">Nombre</th>
									<th class="border border-dark text-center" scope="col">Apellido</th>
...
<?php /**PATH E:\wamp64\proyecto-final\resources\views/vistagestionusuarios.blade.php ENDPATH**/ ?>