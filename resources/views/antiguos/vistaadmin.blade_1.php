...
<!--			<ul class="nav mb-4">
			...
			<div class="container bg-light mb-4 p-2">
				...
				<div class="input-group  h-100 p-0 g-0 border border-danger">
                                    <div class="row w-100 g-0 m-auto  p-0 h-100 border border-danger">
                                    ...
                                    <div class="row h-100 mh-100 my-auto p-0 border w-100 border-danger" style="min-height:100%">
                                        ...
                                        <?php 
                                           ...
                                           ?>
                                            ...
                                            <div class="col-1"></div>
                                            <a class=" col-5 cursorClickIcon text-center my-auto py-auto p-0 h-100" data-bs-toggle="modal" data-bs-target="#searchModal" style="font-size: 0.85em"><img src="iconos/busquedaAvanzadaIcono.png" height="25em"> <span></span>Búsqueda avanzada</a>
                                         </div>
                                     </div>
                                        <div class="col-1">
                                         </div>
		...
		<div class="modal fade" id="searchModal" tabindex="-1" aria-labelledby="searchModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header" style="background-image:linear-gradient()">
